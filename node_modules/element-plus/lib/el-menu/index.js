import { openBlock, createBlock, Transition, mergeProps, toHandlers, withCtx, renderSlot, ref, defineComponent, getCurrentInstance, computed, watch, provide, onMounted, resolveComponent } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock(Transition, mergeProps({ mode: "out-in" }, toHandlers($setup.on)), {
    default: withCtx(() => [
