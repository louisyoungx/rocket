import { reactive, ref, computed, watch, onMounted, nextTick, onBeforeUnmount, provide, openBlock, createBlock, withModifiers, createVNode, Transition, withCtx, withDirectives, vShow, createCommentVNode, renderSlot, Fragment, renderList, toDisplayString } from 'vue';
        ...
        ? (openBlock(), createBlock(Transition, {
            ...
            default: withCtx(() => [
              withDirectives(createVNode("button", {
                ...
                onClick: _cache[3] || (_cache[3] = withModifiers($event => ($setup.throttledArrowClick($setup.data.activeIndex - 1)), ["stop"]))
              }, [
                _hoisted_1
              ], 544 /* HYDRATE_EVENTS, NEED_PATCH */), [
                [vShow, 
            ($props.arrow === 'always' || $setup.data.hover) &&
              ($setup.props.loop || $setup.data.activeIndex > 0)
          ]
              ])
            ]),
            _: 1
        ...
        ? (openBlock(), createBlock(Transition, {
            ...
            default: withCtx(() => [
              withDirectives(createVNode("button", {
                ...
                onClick: _cache[6] || (_cache[6] = withModifiers($event => ($setup.throttledArrowClick($setup.data.activeIndex + 1)), ["stop"]))
              }, [
                _hoisted_2
              ], 544 /* HYDRATE_EVENTS, NEED_PATCH */), [
                [vShow, 
            ($props.arrow === 'always' || $setup.data.hover) &&
              ($setup.props.loop || $setup.data.activeIndex < $setup.items.length - 1)
          ]
              ])
            ]),
            _: 1
