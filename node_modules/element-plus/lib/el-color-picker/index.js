import { defineComponent, getCurrentInstance, ref, computed, watch, onMounted, openBlock, createBlock, createVNode, watchEffect, Fragment, renderList, inject, reactive, nextTick, provide, resolveComponent, resolveDirective, withDirectives, withCtx, createCommentVNode, withKeys, createTextVNode, toDisplayString, vShow } from 'vue';
...
const _hoisted_2$2 = { class: "el-color-dropdown__main-wrapper" };
const _hoisted_3$1 = { class: "el-color-dropdown__btns" };
const _hoisted_4 = { class: "el-color-dropdown__value" };
const _hoisted_5 = {
  key: 0,
...
const _hoisted_7 = { class: "el-color-picker__icon el-icon-arrow-down" };
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createBlock("div", _hoisted_1$2, [
      ...
      trigger: withCtx(() => [
        createVNode("div", {
          ...
          createVNode("div", {
            ...
            withDirectives(createVNode("span", _hoisted_7, null, 512 /* NEED_PATCH */), [
