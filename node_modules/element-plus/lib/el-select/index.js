import { inject, computed, getCurrentInstance, watch, defineComponent, reactive, toRefs, onBeforeUnmount, withDirectives, openBlock, createBlock, withModifiers, renderSlot, createVNode, toDisplayString, vShow, onMounted, ref, nextTick, provide, resolveComponent, resolveDirective, withCtx, createCommentVNode, Transition, Fragment, renderList, withKeys, vModelText, createSlots } from 'vue';
...
var script$1 = {
    ...
    setup() {
        ...
        const minWidth = computed(() => { var _a; return ((_a = select.selectWrapper) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect().width) + 'px'; });
        onMounted(() => {
        });
        return {
            minWidth,
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("div", {
    class: ["el-select-dropdown", [{ 'is-multiple': $setup.isMultiple }, $setup.popperClass]],
...
const useSelect = (props, states, ctx) => {
    ...
    const doDestroy = () => {
        var _a, _b;
        (_b = (_a = popper.value) === null || _a === void 0 ? void 0 : _a.doDestroy) === null || _b === void 0 ? void 0 : _b.call(_a);
    };
    const handleClose = () => {
        states.visible = false;
    };
    ...
    createVNode(_component_el_popper, {
      ...
      default: withCtx(() => [
        createVNode(Transition, {
          ...
          default: withCtx(() => [
            withDirectives(createVNode(_component_el_select_menu, { ref: "popper" }, {
              default: withCtx(() => [
              ...
              [vShow, _ctx.visible && _ctx.emptyText !== false]
            ])
          ]),
          _: 1
      ...
      _: 1
    }, 8 /* PROPS */, ["visible", "append-to-body"])
  ], 2 /* CLASS */)), [
