import { getCurrentInstance, ref, unref, computed, watch, nextTick, isRef, resolveComponent, openBlock, createBlock, withCtx, createVNode, Fragment, renderList, createTextVNode, toDisplayString, onBeforeMount, onMounted, onUpdated, onUnmounted, h, defineComponent, watchEffect, resolveDirective, renderSlot, withDirectives, createCommentVNode, vShow } from 'vue';
...
import { addClass, hasClass, removeClass, getStyle } from '../utils/dom';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock(_component_el_popper, {
    ref: "tooltip",
    visible: $setup.tooltipVisible,
    "onUpdate:visible": _cache[6] || (_cache[6] = $event => ($setup.tooltipVisible = $event)),
    offset: 0,
      ...
      ($setup.multiple)
        ? (openBlock(), createBlock("div", _hoisted_1, [
              ...
              createVNode(_component_el_scrollbar, {
                ...
                default: withCtx(() => [
                  createVNode(_component_el_checkbox_group, {
                    modelValue: $setup.filteredValue,
                    "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => ($setup.filteredValue = $event)),
                    class: "el-table-filter__checkbox-group"
                  }, {
                    default: withCtx(() => [
                      (openBlock(true), createBlock(Fragment, null, renderList($setup.filters, (filter) => {
            ...
            createVNode("div", _hoisted_3, [
              createVNode("button", {
                class: { 'is-disabled': $setup.filteredValue.length === 0 },
                disabled: $setup.filteredValue.length === 0,
                type: "",
                onClick: _cache[2] || (_cache[2] = (...args) => ($setup.handleConfirm(...args)))
              }, toDisplayString($setup.t('el.table.confirmFilter')), 11 /* TEXT, CLASS, PROPS */, ["disabled"]),
              createVNode("button", {
                type: "",
                onClick: _cache[3] || (_cache[3] = (...args) => ($setup.handleReset(...args)))
              }, toDisplayString($setup.t('el.table.resetFilter')), 1 /* TEXT */)
            ])
          ]))
        : (openBlock(), createBlock("ul", _hoisted_4, [
            createVNode("li", {
              class: [{
            'is-active': $setup.filterValue === undefined || $setup.filterValue === null,
          }, "el-table-filter__list-item"],
              onClick: _cache[4] || (_cache[4] = $event => ($setup.handleSelect(null)))
            }, toDisplayString($setup.t('el.table.clearFilter')), 3 /* TEXT, CLASS */),
            (openBlock(true), createBlock(Fragment, null, renderList($setup.filters, (filter) => {
              return (openBlock(), createBlock("li", {
                key: filter.value,
                class: [{ 'is-active': $setup.isActive(filter) }, "el-table-filter__list-item"],
                label: filter.value,
                onClick: $event => ($setup.handleSelect(filter.value))
    ...
    trigger: withCtx(() => [
      createVNode("span", {
        ...
        onClick: _cache[5] || (_cache[5] = (...args) => ($setup.showFilterPanel(...args)))
      }, [
        createVNode("i", {
          class: [
            'el-icon-arrow-down',
            $props.column.filterOpened ? 'el-icon-arrow-up' : '',
          ]
        }, null, 2 /* CLASS */)
      ])
    ]),
