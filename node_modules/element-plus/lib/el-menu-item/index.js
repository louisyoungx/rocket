import { inject, computed, getCurrentInstance, onMounted, onBeforeUnmount, resolveComponent, openBlock, createBlock, withCtx, renderSlot, createVNode, Fragment } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("li", {
    ...
    role: "menuitem",
    tabindex: "-1",
    style: [$setup.paddingStyle, $setup.itemStyle, { backgroundColor: $setup.backgroundColor }],
    ...
    (
        $setup.parentMenu.type.name === 'ElMenu' &&
          $setup.rootMenu.props.collapse &&
          $setup.slots.title
      )
