...
import { inject, computed, reactive, ref, getCurrentInstance, provide, onBeforeMount, onMounted, onBeforeUnmount, resolveComponent, openBlock, createBlock, withCtx, createVNode, Transition, withDirectives, renderSlot, vShow, createCommentVNode } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("li", {
    class: [
      'el-submenu',
      $setup.active && 'is-active',
      $setup.opened && 'is-opened',
      $props.disabled && 'is-disabled',
    ],
    role: "menuitem",
    "aria-haspopup": "true",
    "aria-expanded": "opened",
    onMouseenter: _cache[11] || (_cache[11] = (...args) => ($setup.handleMouseenter(...args))),
    onMouseleave: _cache[12] || (_cache[12] = () => $setup.handleMouseleave(false)),
    onFocus: _cache[13] || (_cache[13] = (...args) => ($setup.handleMouseenter(...args)))
  }, [
    ($setup.isMenuPopup)
      ? (openBlock(), createBlock(_component_el_popper, {
          key: 0,
          ref: "popperVnode",
          visible: $setup.opened,
          "onUpdate:visible": _cache[7] || (_cache[7] = $event => ($setup.opened = $event)),
          "manual-mode": true,
          effect: "light",
          pure: true,
          offset: 6,
          "show-arrow": false,
          "popper-class": $setup.props.popperClass,
          placement: $setup.data.currentPlacement,
          "append-to-body": $setup.appendToBody
        }, {
          default: withCtx(() => [
            createVNode(Transition, { name: $setup.menuTransitionName }, {
              default: withCtx(() => [
                withDirectives(createVNode("div", {
                  ref: "menu",
                  class: [`el-menu--${$setup.mode}`, $setup.props.popperClass],
                  onMouseenter: _cache[1] || (_cache[1] = $event => $setup.handleMouseenter($event, 100)),
                  onMouseleave: _cache[2] || (_cache[2] = () => $setup.handleMouseleave(true)),
                  onFocus: _cache[3] || (_cache[3] = $event => $setup.handleMouseenter($event, 100))
                }, [
                  createVNode("ul", {
                    role: "menu",
                    class: [
                'el-menu el-menu--popup',
                `el-menu--popup-${$setup.data.currentPlacement}`,
              ],
                    style: { backgroundColor: $setup.rootProps.backgroundColor || '' }
                  }, [
          ...
          trigger: withCtx(() => [
            createVNode("div", {
              ...
              style: [$setup.paddingStyle, $setup.titleStyle, { backgroundColor: $setup.backgroundColor }],
              onClick: _cache[4] || (_cache[4] = (...args) => ($setup.handleClick(...args))),
              onMouseenter: _cache[5] || (_cache[5] = (...args) => ($setup.handleTitleMouseenter(...args))),
              onMouseleave: _cache[6] || (_cache[6] = (...args) => ($setup.handleTitleMouseleave(...args)))
            }, [
              renderSlot(_ctx.$slots, "title"),
              createVNode("i", {
                class: ['el-submenu__icon-arrow', $setup.submenuTitleIcon]
              }, null, 2 /* CLASS */)
    ...
    (!$setup.isMenuPopup)
      ? (openBlock(), createBlock("div", {
          ...
          class: "el-submenu__title",
          style: [$setup.paddingStyle, $setup.titleStyle, { backgroundColor: $setup.backgroundColor }],
          onClick: _cache[8] || (_cache[8] = (...args) => ($setup.handleClick(...args))),
          onMouseenter: _cache[9] || (_cache[9] = (...args) => ($setup.handleTitleMouseenter(...args))),
          onMouseleave: _cache[10] || (_cache[10] = (...args) => ($setup.handleTitleMouseleave(...args)))
        }, [
          renderSlot(_ctx.$slots, "title"),
          createVNode("i", {
            class: ['el-submenu__icon-arrow', $setup.submenuTitleIcon]
